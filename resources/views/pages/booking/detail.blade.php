                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <div class="flex justify-between">
                         ...
                         <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]"  id="discount">
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">Rp {{ number_format($transaction->class->price * $transaction->number_of_passengers * 0.11, 0, ',', '.') }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-garuda-grey">Grand Total</p>
                                <p class="font-bold text-2xl leading-9 text-garuda-blue mt-[2px]" id="grand-total">Rp {{ number_format($transaction->class->price * $transaction->number_of_passengers * 1.11, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <label class="flex flex-col gap-[10px]">
                            ...
                            <div class="flex items-center rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                ...
                                <p class="font-semibold">angga@great.com</p>
                            </div>
                        </label>
                        <label class="flex flex-col gap-[10px]">
